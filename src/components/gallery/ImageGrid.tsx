  ...
  const GRID_LAYOUT_CONFIG = [
    {
      ...
      mobileClassName: "col-span-3 col-start-1 col-end-3 row-span-3",
    },
    {
      id: "2",
    ...
    },
    {
      id: "3",
      className:
        "lg:col-start-6 lg:col-end-7 lg:row-start-1 lg:row-span-2 lg:col-span-2",
      tabletClassName: "md:col-span-2 md:row-span-3",
    ...
    },
    {
      ...
      tabletClassName: "md:col-span-4 md:row-span-3",
      mobileClassName: "col-span-2 row-span-4",
    },
    {
      id: "6",
    ...
    },
    {
      ...
      tabletClassName: "md:col-span-3 md:row-span-4",
      mobileClassName: "col-span-3 row-span-4",
    },
    {
      id: "9",
  ...
  return (
    <div
      className={cn(
        ...
        "grid grid-cols-4 gap-2 auto-rows-[60px]",
